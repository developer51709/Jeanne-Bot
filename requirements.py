...
os.system(
    "pip install -U discord.py aiohttp websockets requests asyncio python-dotenv humanfriendly datetime Pillow py-expression-eval topggpy reactionmenu jishaku pandas openpyxl openai markdown"
)
